...
class BasePaymentProcessor(object):  # pragma: no cover
    ...
    def handle_processor_response(self, response, basket=None):
        ...
        This method does the following:
            ...
            2. Save the response to the database for auditing.
            3. Create PaymentEvents and Sources for successful payments.
    ...
    def is_response_valid(self, response):
        """ Returns a boolean indicating if the response from the payment processor is valid. """
        raise NotImplementedError
    ...
    def record_processor_response(self, transaction_id, response, basket=None):
        """
        Save the processor's response to the database for audting.
...
class Cybersource(BasePaymentProcessor):
    ...
    def __init__(self):
        ...
        self.endpoint = configuration['pay_endpoint']
    ...
    def handle_processor_response(self, response, basket=None):
        ...
        if not self.is_response_valid(response):
            logger.info(u'CyberSource payment processor received a response with an invalid signature: %s',
                        json.dumps(response))
        ...
        # TODO Handle case where auth_amount is not equal to the basket total.
