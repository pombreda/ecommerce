...
class PaymentEventsMixin(object):
    ...
    def assert_basket_matches_source(self, basket, source, source_type, reference):
        """
    ...
    def assert_payment_source_exists(self, basket, source_type, reference):
        ...
        self.assert_basket_matches_source(basket, source, source_type, reference)
...
class CyberSourceMixin(object):
    ...
    def generate_notification(self, secret_key, basket, decision=u'ACCEPT', billing_address=None, auth_amount=None,
        ...
        notification = {
            u'decision': decision,
            u'req_reference_number': req_reference_number or unicode(basket.id),
        ...
        if billing_address:
            notification.update({
                ...
                u'req_bill_to_address_line2': billing_address.line2,
